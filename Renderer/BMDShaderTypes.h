...
#ifndef BMDShaderTypes_h
#define BMDShaderTypes_h
...
typedef enum AAPLColorIndex
{
    AAPLColorConstantRed,
    AAPLColorConstantGreen,
    AAPLColorConstantBlue,
} AAPLColorIndex;

#endif /* BMDShaderTypes_h */
