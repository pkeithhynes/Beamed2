...
#define kLoopMusic4 @"PuzzleBackgroundTheme2"
#define kLoopMusic5 @"MysteryPuzzleLoop2"
...
enum ePuzzleCompletionCondition { ALL_JEWELS_ENERGIZED, TILE_POSITIONING_AND_ROTATION, USER_TOUCH, TUTORIAL_PUZZLE_COMPLETE };
// --- Tiles
